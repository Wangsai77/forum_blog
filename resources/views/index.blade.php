...
<head>
	...
	<link rel="icon" type="image/x-icon" href="../images/heada.jpg">
	<title>小赛同学</title>
...
<body>
	<nav>
		<a href="index.html" target="_blank" class="active">首页</a> <a class="clip"></a>
		<a href="photo.html" target="_blank">相册</a>
		<a class="clip"></a> <a href="https://Wangsai77.github.io" target="_blank">文章</a>
		<a class="clip"></a> <a href="comments.html" target="_blank">留言板</a>
	</nav>
	...
	<body onContextMenu="alert('禁止查看源代码，您的行为已记录。'); return false"
		...
		<div class="main">
			...
			<div class="ch about">
				<div class="container">
					<h2 class="chtitle">Who am <span>小赛同学</span>？</h2>
					<div class="clear">
						<div class="introduct">
							<img class="avatar"
								src="https://i.328888.xyz/2023/01/15/2IMXc.jpeg">
							<P style="padding-top:1em;">坚硬的代替了那些柔软的，清晰的取代了那些模糊的。那些滑溜溜和黏糊糊的东西，带你来到了世界的角落。</p>
							<br>
							<p>你好，这里是小赛同学，20岁，是学生，热爱计算机互联网事业，对有趣的世界和可能有趣的你充满好奇，小赛同学在努力...
							</p> <br>
							<p>
								一望无际的迷雾中，有人在寻找光明！很高兴遇到你，我们一直在耕耘这么一片简单的土壤，虽然没有尽善尽美，但以初见雏形。<br>
								<br>十年前我们仰望星空，十年后我们将俯视大地，未来的天空，必将为我们留下一片灿烂的曙光！
							</p>
							<div class="chatbox">
			...
			<div class="find ch">
				<div class="container links">
					<h2 class="chtitle">小赛同学出没的<span>地方</span></h2>
					<div class="clear col-3">
						<a href="https://blog.csdn.net/mhengwo?spm=1000.2115.3001.5343" target="_blank">
							<div class="item">
								<div class="bg" style="background-color:#28a9e0"></div>
								<div class="inner"> <span>CSDN博客</span> </div>
							</div>
						</a>
						<a href="https://home.cnblogs.com/u/3076964" target="_blank">
							<div class="item">
								<div class="bg" style="background-color:#28a9e0"></div>
								<div class="inner"> <span>博客园</span> </div>
							</div>
						</a>
						<a href="https://vr.justeasy.cn/view/h16sx67e97x90z36-1667979172.html" target="_blank">
							<div class="item">
								<div class="bg" style="background-color:#28a9e0"></div>
					...
					<div class="clear">
						<a href="#" target="_blank">
							<div class="item">
								<div class="bg" style="background-color:#28a9e0"></div>
								<div class="inner"> <i class="icon-twitter"></i> <span>Twitter</span> </div>
							</div>
						</a>
						<a href="#" target="_blank">
							<div class="item">
		...
		<div class="footer ch">
			<div class="container">
				<h3>小赛同学在努力</h3>
				<p>蘑菇森林的尽头，新世界的起点</p>
				<p class="c"><a href="#" target="_blank">Say hello to me </a></p>
			</div>
		</div>
		</div>
